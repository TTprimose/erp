                ...
                <el-form id="supplier_form" :inline="true" ref="addSupplierForm" :rules="rules" :model="formData" label-position="right" size="small" label-width="120px">
                    ...
                    <div>
                        <el-form-item prop="provinceId" label="区域">
                            <area-cader ref="suplierArea" v-on:areaFromChild="areaCallBack"></area-cader>
                        </el-form-item>
...
export default {
    ...
    data(){
        return {
            ...
            formData: {
                sellerCompanyName: '',
                sellerCompanyNo: this.myBase.MathRand2('SUP'),
                provinceId: '',
                cityId: '',
                areaId: '',
    ...
    activated(){
        ...
        this.formRestEvent()
        this.formData.sellerCompanyNo = this.myBase.MathRand2('SUP')
        this.suplierArea.modelValue = []
    },
    created(){},
    mounted(){
        this.suplierArea = this.$refs.suplierArea
    }
}
</script>
<style scoped>
