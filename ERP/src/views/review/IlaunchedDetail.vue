<template>
    <div id="waitReview_Wrap">
        <div class="model_topcol">
            <span style="color: #409EFF">我发起的</span>
            ...
            <div class="model_content_inner">
                ...
                <div :style="{height: $store.state.home.modelContentHeight - 250 + 'px', overflow: 'auto'}" class="maincontent">
                    ...
                    <div v-if="$store.state.home.currentModelId.auditStatus == 0 || $store.state.home.currentModelId.auditStatus == 1" class="item_wrap item_wrap_curr">
                        ...
                        <span class="color_brown" style="margin-left: 15px">待审核</span><br>
        ...
        <div class="model_footer">
            <el-button v-if="$store.state.home.currentModelId.auditStatus != 2 && $store.state.home.currentModelId.auditStatus != 3" @click="recallEvent" type="primary" size="small" style="width: 90px; margin-left: 25px;">撤销审核</el-button>
...
export default {
    data(){
        return {
            ...
            reviewRecordData: [],
            reviewManList: [],
            localData: null, //缓存数据,避免页面之间跳转localstorge数据混乱
            waitTime: '10: 10',
            formData: {
                maker: ''
            }
    ...
    methods:{
        ...
        recallEvent(){
            var paramobj = {
                ...
                processType: this.localData.processType,
